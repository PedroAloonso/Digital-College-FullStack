    ...
    <section className={style.container}>
      ...
      <div className={style.featuredCollectionsBotton}>
        ...
        <div>
          ...
          <FeaturedItemCategory text={"Bonés"}>{cap_icon}</FeaturedItemCategory>
          <FeaturedItemCategory text={"Headphones"}>{headPhones_icon}</FeaturedItemCategory>
          <FeaturedItemCategory text={"Tênis"}>{tennis_icon}</FeaturedItemCategory>
        </div>
      </div>
    </section>
  );
